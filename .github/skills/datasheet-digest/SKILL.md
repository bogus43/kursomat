...
description: >
  ...
  a reference card for an IC / sensor / protocol / module.
  Do NOT use for: full document translation, general PDF summarization unrelated
  to hardware/firmware development.
---
...
- Detailed block diagrams descriptions
...
## Config File: `.datasheet-digest.yml`

```yaml
# .datasheet-digest.yml — optional defaults for this project
focus: ""           # empty = auto-detect; or e.g. "I2C communication only"
lang: en            # en | pl
output_file: ""     # empty = derived from device name
append: false       # true = append to existing digest file
```
...
Inline override — append to prompt:
